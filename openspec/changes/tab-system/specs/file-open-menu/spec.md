...
The system SHALL display a native application menu bar with an "Archivo" menu containing "Abrir..." (Ctrl+O), "Cerrar pestaña" (Ctrl+W), a separator, and "Salir" (Alt+F4 / Cmd+Q).
